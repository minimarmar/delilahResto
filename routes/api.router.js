...
router.get('/pedidos/:id', userValidation.isAuthorized, pedidosController.getPedidos)
router.get('/pedidos/:id', userValidation.isAuthorized, pedidosController.getById)
